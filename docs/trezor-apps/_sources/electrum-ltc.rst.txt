 .. note:: We are currently moving the documentation to a new platform. Please visit `Trezor Wiki <https://wiki.trezor.io/Apps:Electrum-LTC>`_ for the latest version of this page.
...
is a Litecoin lightweight desktop wallet for Windows, Linux and macOS based on Electrum.
...
----------------------------------------------------------------------- -----------------------------------------------------------------------------------------------------------
:icon:`laptop` Platform                             ✔                   Windows, Linux, macOS
